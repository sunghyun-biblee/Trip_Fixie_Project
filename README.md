...
> ## 💭 회고
    ...
    학습 과정에서 Javascript의 부족했던 개념들 `(map, 스프레드 연산자, 구조 분해 할당 ...)` 을 익힐 수 있었습니다. <br/>
    프로젝트 리드 역할을 맡아 소통하게 되면서 다른 분야의 지식을 쌓으며, 팀원의 어려움을 이해할 수 있었습니다. <br/>
    firebase를 통하여 인증서비스의 OAuth 기능을 사용하여 소셜로그인을 구현해면서,로그인을 구현할때 필요로 하던 CRUD 과정이 사라지니, 많은 시간을 절약할 수 있던것이 좋았습니다.
